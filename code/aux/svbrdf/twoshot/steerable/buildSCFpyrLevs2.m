...
function coeff = buildSCFpyrLevs2(lodft,log_rad,Xrcos,Yrcos,angle,ht,nbands)
...
if (ht <= 1)
    ...
    for b = 1:nbands
        ...
        banddft = ((-1i)^(nbands-1)) .* lodft .* repmat(anglemask .* himask, [1 1 S(3:end)]);
    ...
    temp = buildSCFpyrLevs2(lodft, log_rad, Xrcos, Yrcos, angle, ht-1, nbands);
